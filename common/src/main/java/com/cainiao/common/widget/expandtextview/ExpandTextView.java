package com.cainiao.common.widget.expandtextview;
...
//    protected ImageButton mButton; // Button to expand/collapse
    ...
    public void onClick(View view) {
        if ( view == mTvTips ||view == ll_expand) {

            mCollapsed = !mCollapsed;

            if (mCollapsed) {
                mTvTips.setText(R.string.msg_more);
            } else {
                mTvTips.setText(R.string.msg_collapse);
            }
...
//        mButton.setVisibility(View.VISIBLE);
    ...
    private void findViews() {
        ...
        mTvTips = (TextView) findViewById(R.id.expand_status);
        ...
        ll_expand = (RelativeLayout) findViewById(R.id.ll_expand);
